...
三味书屋图像档案处理软件是一款针对档案行业，带有专业性质的图像软件，功能包括**格式转换**、**图像重命名**、**图像压缩**、**水印保护**、**ICO转换**等功能。软件专注于图像档案的处理，软件格式支持包括 ICO、JPEG、JPG、WEBP、TIFF 在内的超过100种的图片格式，软件提供快速且高质量的批量图片处理功能，软件界面简洁，操作方便，是处理图像格式处理的理想工具。
...
# 二、更新说明（最新为4.1 版本）
	...
	1. “图像重命名”模块增加“起始序号”
	2. “图像重命名”模块文件读取顺序与Windows资源管理器一致
	3. “图像重命名”模块支持排序更改
	4. “图像重命名”模块支持鼠标拖动数据更改数据顺序
	5. “图像压缩”模块增加“按文件大小筛选”
